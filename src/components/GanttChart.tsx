      ...
      >
        <div className="min-w-full inline-block">
          ...
          <div className="relative">
            ...
            >
                 <div className="p-2 font-semibold text-sm border-r dark:border-zinc-700 bg-gray-50 dark:bg-zinc-800 sticky left-0 z-30 w-[200px] h-full flex items-center truncate text-gray-400 italic pointer-events-none">
            ...
            {tasks.map(task => {
              ...
              return (
                ...
                >
                  <div className="p-2 truncate font-medium border-r dark:border-zinc-700 bg-white dark:bg-zinc-900 sticky left-0 z-30 w-[200px] h-full flex items-center">
                    {task.name}
                  </div>
